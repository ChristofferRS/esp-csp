...
#include "vmem/vmem_flash.h"

VMEM_DEFINE_FLASH(conf, "conf", 0x6000, 0x00)
PARAM_DEFINE_STATIC_VMEM(1, boot_cnt, PARAM_TYPE_UINT16, -1 ,0, PM_CONF, NULL, NULL, conf, 0x0010, NULL);
...
void app_main(){
    ...
    csp_rtable_set(18, 11, &lora_iface, CSP_NO_VIA_ADDRESS);
